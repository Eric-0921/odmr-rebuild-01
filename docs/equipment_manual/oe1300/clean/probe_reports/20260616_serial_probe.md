...
> **后续补充**：同日又探测了一台 **OE1301**（SN:L2283261，固件 `V1.4h4-1.02-1.4.0.23B`），其 set 命令大部分静默生效，与 OE1351 行为不同。详见 [`20260616_serial_probe_oe1301.md`](./20260616_serial_probe_oe1301.md)。
