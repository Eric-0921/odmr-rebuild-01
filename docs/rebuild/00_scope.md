...
- `odmr station verify --station <station.json>`
- `odmr run execute --station <station.json> --calibration <calibration.json> --plan <plan.json>`
- `odmr run watch --run <run_dir>`
- `odmr run replay --run <run_dir>`
