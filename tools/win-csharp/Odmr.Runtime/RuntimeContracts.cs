...
public static class RuntimeContracts
{
    public const string Oe1022dFrozenRallHotPath =
        "write RALL?, sleep 30ms, blocking exact read 12288B, detect duplicate by packet counter, direct-decode unique frames only, append collector_frames + unique-only parameter_values + unique-only sample_values";
